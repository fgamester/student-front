...
<template>
  ...
  >
    <div class="flex flex-col w-full items-start justify-start gap-1">
      ...
      <input
        class="w-full bg-2 text-6 placeholder:text-4 rounded-md p-1"
        type="text"
        id="f-name"
    ...
    <div class="flex flex-col w-full items-start justify-start gap-1">
      ...
      <textarea
        class="w-full bg-2 text-6 placeholder:text-4 rounded-md p-1 resize-none"
        rows="2"
        id="address"
    ...
    <div class="w-full">
      <button class="bg-3 text-6 p-2 rounded-md w-full mt-3" type="submit">
        Crear Usuario
      </button>
    </div>
  </form>
